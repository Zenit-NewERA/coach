 ...
 *    $Revision: 1.2 $
 *
 *    $Id: geometry.C,v 1.2 2004/04/09 06:35:06 anton Exp $
 *
 ************************************************************************/
/***************************************************************************
 *                                                                         *
...
bool Ray::InRightDir(AngleDeg ang) {
  return fabs( GetNormalizeAngleDeg(ang - direction.dir()) ) < 10;
}
/********************************************************************************/
bool Ray::InOppositeDir(Vector& pt){
  return fabs(GetNormalizeAngleDeg((pt - origin).dir() - direction.dir() + 180)) < 10;
}
/********************************************************************************/
bool Ray::InOppositeDir(AngleDeg ang){
  return fabs(GetNormalizeAngleDeg(ang - direction.dir() + 180)) < 10;
}
/********************************************************************************/
